...
> [!IMPORTANT]
> 该软件为**空壳影视播放器**，无内置播放源和直播源，需要自行收集配置。
...
- 🔍 **多源聚合搜索**：一次搜索，聚合多个播放源结果
- ▶️ **流畅在线播放**：集成 HLS.js，支持剧集选集播放
- ⚙️ **播放源管理**：支持播放源导入 / 导出与批量管理
- 🌗 **暗黑主题**：支持暗黑主题
- ...
...
| 平台       | 架构        | 说明           |
| ---------- | ----------- | -------------- |
| 🪟 Windows | x64 / arm64 | 安装包或便携版 |
| 🍎 macOS   | x64 / arm64 | `.dmg` 安装包  |
